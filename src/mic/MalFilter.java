/* $Id: MalFilter.java,v 1.2 2005/02/22 05:28:25 RMS Exp $
 *
 *  MalFilter.java
 *
 ...
 *   Oberlin, OH 44074
*/
public class MalFilter extends FileFilter {
  ...
  public boolean accept(File f) {
    ...
    if (extension != null) {
      if (extension.equals("mal")) return true;
      else return false;
    }
    return false;
  }
